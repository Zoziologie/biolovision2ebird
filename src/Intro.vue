...
<template>
  <b-row class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <b-col lg="12">
      <p>
        <strong>Biolovision2eBird</strong> helps you to import your bird sightings from any Biolovision website (e.g.
        <b-link href="https://www.ornitho.ch/" target="_blank">ornitho.ch</b-link>,
        <b-link href="http://faune-alsace.org/" target="_blank">faune-alsace</b-link>,...) to eBird! It is now also
        possible to convert data from the Observation websites (e.g.,
    ...
    <b-col lg="6">
      ...
      <ol>
        ...
        <li>
          ...
          <b-link href="https://ebird.org/import/upload.form" target="_blank">eBird import tool</b-link>.
        </li>
        <li>
    ...
    <b-col>
      <b-alert variant="danger" show class="mt-3">
        <h4 class="alert-heading"><b-icon icon="exclamation-octagon" class="mr-1"> </b-icon>Prerequisites</h4>
      ...
      <b-alert variant="warning" show class="mt-3">
        <h4 class="alert-heading"><b-icon icon="exclamation-triangle" class="mr-1" />Important Information</h4>
        <ol>
          <li>
            Mapping the protocol of the original system used (Biolovision, Birdlasser or Observation) to eBird is not
            always simple. In accordance with
            <b-link
            ...
            >, we encourage the use of complete checklist with the stationary and traveling protocol. In general, lists
            should be converted to traveling or stationary by adding information on (1) number of observers and (2)
            distance traveled. If these two information cannot be provided, lists will use the historical protocol.
            Individual direct observations (i.e., sightings) should be converted to incidental checklists if birding was
            not your primary purpose or to incomplete traveling, stationary or historical protocols.
          </li>
          <li>
            We encourage you to keep the link to your sightings on the original website in the species comment so that
            the eBird reviewing team can validate your record more easily.
          </li>
          <li>
            For importing a life list without complying to eBird core requirement (e.g., over multiple days or
            locations), read
            <b-link
    ...
    <b-col lg="12" class="text-center">
      <b-button variant="secondary" size="lg" :disabled="important_information.length < 3" @click="$emit('skipIntro')">
        Continue
      </b-button>
    </b-col>
  </b-row>
